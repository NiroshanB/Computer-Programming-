...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        try {
            ...
            FileReader fr = new FileReader("reminderGroups.txt");
            BufferedReader br = new BufferedReader(fr);
    ...
    public void newReminderGroup(ActionEvent actionEvent) throws IOException {
        ...
        FileWriter fw2 = new FileWriter(groupName.getText() + ".txt", true);
        //add new group to list
        loadReminderGroups.getItems().add(groupName.getText());
        //open reminderGroups file to append to
        FileWriter fw = new FileWriter("reminderGroups.txt", true);
        //write to file
        BufferedWriter bw = new BufferedWriter(fw);
        bw.write(groupName.getText() + "\n");
